        ...
        <header>
            <nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark border-bottom border-body" data-bs-theme="dark">
                <div class="container-fluid">
                    <a class="navbar-brand" href="/proje">RMDB</a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="/proje/kategoriler.php">Kategoriler</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="d-flex">
                        <a class="btn btn-outline-light" href="/proje/giris-yap.php">Giriş Yap</a>
                    </form>
                    </div>
                </div>
            </nav>
